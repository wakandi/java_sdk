...
public class TokenService extends LedgefarmService
{
	...
	public Transaction issue(String toWallet, String token, double amount, List<Fee> fee)  throws IOException,LedgefarmException
	{
	...
	public Transaction issue(String toWallet, String token, double amount, String transactionNumber, String paymentMode, List<Fee> fee)  throws IOException,LedgefarmException
	{
		JsonElement jsonTree = new JsonParser().parse(super.gson.toJson(fee));
		JsonObject dataObj = new JsonObject();
		dataObj.addProperty("amount",new Double(amount));
	...
	public final Transaction transfer(String toWallet, String token, double amount, List<Fee> fee)  throws IOException,LedgefarmException
	{
		JsonElement jsonTree = new JsonParser().parse(super.gson.toJson(fee));
		JsonObject dataObj = new JsonObject();
		dataObj.addProperty("amount",new Double(amount));
	...
	public final Transaction withdraw(String fromWallet, String token, double amount, List<Fee> fee)  throws IOException,LedgefarmException
	{
		JsonElement jsonTree = new JsonParser().parse(super.gson.toJson(fee));
		JsonObject dataObj = new JsonObject();
		dataObj.addProperty("amount",new Double(amount));
	...
	public final Transaction request(String fromWallet, String token, double amount)  throws IOException,LedgefarmException
	{
		JsonObject dataObj = new JsonObject();
		dataObj.addProperty("amount",new Double(amount));
		dataObj.addProperty("token",token);
	...
	{
		JsonObject dataObj = new JsonObject();
		dataObj.addProperty("tokenRequestId",requestId);
